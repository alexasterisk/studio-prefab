...
do
	...
	Madwork = {
		GetShared = function(package_name, item_name)
			...
			return WaitForDescendant(game:GetService("ReplicatedStorage").Madwork, item_name, "module")
		end,
		GetModule = function(package_name, module_name)
			return WaitForDescendant(game:GetService("ServerScriptService").Utilities, module_name, "module")
		end,
